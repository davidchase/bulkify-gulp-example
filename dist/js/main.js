...
},{"/Users/low5mike/WebstormProjects/bulkify-gulp/src/modules/a":10,"/Users/low5mike/WebstormProjects/bulkify-gulp/src/modules/b":11,"/Users/low5mike/WebstormProjects/bulkify-gulp/src/modules/c":12}],2:[function(require,module,exports){
"use strict";
...
},{"./test.hbs":13}],13:[function(require,module,exports){
...
module.exports = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, options, functionType="function", blockHelperMissing=helpers.blockHelperMissing;
  stack1 = ((helper = helpers.names || (depth0 && depth0.names)),(options={"name":"names","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data}),(typeof helper === functionType ? helper.call(depth0, options) : helper));
  if (!helpers.names) { stack1 = blockHelperMissing.call(depth0, stack1, options); }
